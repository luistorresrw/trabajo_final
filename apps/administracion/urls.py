...
urlpatterns = patterns('',
	...
	url(r'^personas/$',  personas, name='personas'),
	url(r'^edit_personas/(?P<id>[0-9A-Za-z]+)/$',  edit_personas, name='edit_personas'),
	url(r'^remove_personas/(?P<id>[0-9A-Za-z]+)/$',  remove_personas, name='remove_personas'),
